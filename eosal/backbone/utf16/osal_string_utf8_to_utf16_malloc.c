...
****************************************************************************************************
  ...
  @anchor osal_string_utf8_to_utf16_malloc

  The osal_string_utf8_to_utf16_malloc() converts an UTF16 encoded string to UTF8 encoded string.
  ...
  str = osal_string_utf8_to_utf16_malloc("My UTF8 string", &sz);
    ...
    os_memsz *sz_ptr)
{
     ...
     */
    sz = osal_string_utf8_to_utf16(OS_NULL, 0, str8);

    /* Allocate buffer for the string.
     */
    buf16 = osal_memory_allocate(sz*sizeof(os_ushort), OS_NULL);

    /* Convert the string from UTF8 to UTF16.
     */
    osal_string_utf8_to_utf16(buf16, sz, str8);
