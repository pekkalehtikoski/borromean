...
****************************************************************************************************
*/
#ifndef OSAL_MUTEX_INCLUDED
#define OSAL_MUTEX_INCLUDED
...
****************************************************************************************************
  ...
  If OSAL_MULTITHREAD_SUPPORT flag is zero, these macos will replace functions and not generate 
  any code. This macros are allow to compile code which call mutex functions without multithreading
  support.
