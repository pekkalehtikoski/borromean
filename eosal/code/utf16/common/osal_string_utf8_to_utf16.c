/**
  ...
  @file    modules/utf16/string/osal_string_utf8_to_utf16.c
...
****************************************************************************************************
  ...
  @anchor osal_string_utf8_to_utf16

  The osal_string_utf8_to_utf16() converts an UTF8 encoded string to UTF16 encoded string,
