/**
  ...
  @file    tests/int64/osal_int64_test.c
    ...
    os_char *argv[])
{
	 ...
	 */
	osal_console_write ("Multiplication and division test... ", 0);
	for (i = 0; i < INT64_TEST_N_DATA; i++)
	{
		osal_int64_copy(&x, int64_test_data+i);
		for (j = 0; j < INT64_TEST_N_DATA; j++)
	 ...
	 */
	osal_console_write ("Large integer division test... ", 0);
